...
// Base class for all Agents
    public class Agent : MonoBehaviour {
        ...
        protected bool InRange => CurrentTarget != null &&
                                  Vector3.Distance(this.transform.position, CurrentTarget.transform.position) <=
                                  Range.BaseValue;
        ...
        protected void FindTarget() {
            ...
            foreach (Agent enemy in allEnemyAgents) {
